...
pub fn main() !MainReturn {
    ...
    if (comptime build_config.app_runtime == .none) {
        ...
        try stdout.print(
            ...
            \\(i.e. Witty.app on macOS). This CLI can be used to perform various
            \\actions such as inspecting the version, listing fonts, etc.
            \\
            \\On macOS, the terminal can also be launched using `open -na Witty.app`,
            \\or `open -na Witty.app --args --foo=bar --baz=qux` to pass arguments.
            \\
